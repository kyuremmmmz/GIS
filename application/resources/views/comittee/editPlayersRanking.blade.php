...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('editRankings', ['data'=>$data])}}" method="post">
                    @csrf
                    @method('put')
                    <div class="mb-3">
                        <label for="playerid" class="form-label">Player Number</label>
                        <input type="text" class="form-control" id="playerid" value="{{$data->playerID}}" name="playerID" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="points" min="0" value="{{$data->points}}" name="points" required>
                    </div>
                    <div class="mb-3">
