<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="Adminname" name="name" type="text" class="block w-full mt-1" :value="old('Adminname', $user->Adminname)" required autofocus autocomplete="name" />
            <x-input-error class="mt-2" :messages="$errors->get('Adminname')" />
        </div>
