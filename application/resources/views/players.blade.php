    ...
    <main class="relative h-screen md:h-[30%] xl:h-[30%] rounded-full lg:h-80 sm:h-96 2xl:h-[100%] bg-slate-500 text-black left-[299px] top-[200px]  float-end">
        ...
        <div class="relative">
            <div class="absolute overflow-y-scroll max-h-[750px] grid self-center left-[-300px] grid-cols-1 items-center justify-center grid-rows-3 rounded-tl-lg gap-4 h-[1050px] text-center w-[1600px] bg-slate-500">
                ...
                <a href="{{route('teams')}}" class="absolute top-2 w-36 float-end right-[930px] btn btn-primary">Teams</a>
                <a href="{{route('viewRankings')}}" class="absolute top-2 w-36 float-end right-[1270px] btn btn-primary">Player Rankings</a>
                <a href="{{route('playersList')}}" class="absolute top-2 w-36 float-end right-[1100px] btn btn-primary">Players</a>
                ...
                <div class="mb-16 overflow-y-scroll max-h-32 bg-slate-900" style="max-height: 500px;">
...
=======
>>>>>>> d05dd5b3cdf0c74141c280273567efe7ef56d59e
                            <tr>
                                <td>{{$index++}}</td>
                                <td>{{$player->name}}</td>
